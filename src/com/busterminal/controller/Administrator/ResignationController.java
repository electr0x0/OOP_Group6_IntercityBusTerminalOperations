...
public class ResignationController {
    ...
    private void acceptResignation() {
        ...
        reasonTextArea.setText("Accepted resignation for: " + selectedResignation.getEmployeeName());
    }
    ...
    private void viewReason() {
        ...
        reasonTextArea.setText("Reason for resignation:\nEmployee: " +
                selectedResignation.getEmployeeName() +
                "\nReason: " + selectedResignation.getResignationReason());
    }
}
