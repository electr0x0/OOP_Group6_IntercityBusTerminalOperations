...
public class SalaryStatusController implements Initializable {
    ...
    private void loadDataFromBinaryFile() {
        ...
        allEmployeeData = FXCollections.observableArrayList(
                new dummySalaryStatusClass(1, "Sawmin", "Manager", 5000, LocalDate.now(), "Paid"),
                new dummySalaryStatusClass(2, "Alif", "Developer", 4500, LocalDate.now(), "Unpaid")
        );
        employeeTable.setItems(allEmployeeData);
    }
