   ...
   private ArrayList<BusTrip> b1 = new ArrayList();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        b1= RelationshipDatabaseClass.getInstance().getAllTripList();
            ...
            for(BusTripSchedule x : b2){
                
                    DummyClassForTableViewSchedule d = new DummyClassForTableViewSchedule(x.getTrip().getBus().getManufacturer(),x.getTrip().getSource(), x.getTrip().getDestination(),x.getTrip().getAdultFare(),x.getTime(),x.getScheduleDate());
